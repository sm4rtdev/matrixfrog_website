      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex mb-6 md:mb-0">
            ...
            <Link href={getNavLink("buybot")}>
              <span className="text-matrix-green hover-white px-4">BuyBot</span>
            </Link>
            <Link href="/migration-protocol">
              <span className="text-matrix-green hover-white px-4">Treasury</span>
            </Link>
        ...
        <div className="mt-8 text-center">
          <p className="text-matrix-green text-xs opacity-60">
            &copy; {new Date().getFullYear()} MATRIXFROG. All rights reserved. The choice is yours.
          </p>          
        </div>
      </div>
    </footer>
