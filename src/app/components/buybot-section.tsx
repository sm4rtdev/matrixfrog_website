...
export default function BuyBotSection() {
  ...
  const [activeTab, setActiveTab] = useState<'what' | 'how' | 'why' | 'command'>('what');
  ...
  useEffect(() => {
    const textToType = "MATRIX BUYBOT: REAL-TIME MONITORING";
  ...
  const tabContents = {
    what: (
      <div className="terminal-text-container">
        <h3 className="text-matrix-green font-bold text-xl mb-4">What Is the $MATRIX BuyBot?</h3>
        <p className="text-white leading-relaxed mb-4">
        The $Matrix BuyBot is a customizable Telegram bot designed to display and monitor transaction on the blockchain in real time. The end user can customize the bot as they see fit to enhance transparency, as well as building excitment by displaying data-rich notifications directly to the communities chat.
        </p>
        <p className="text-white leading-relaxed">
          It not only enhances transparency but also builds excitement by delivering engaging, data-rich notifications directly to your chat.
        </p>
      </div>
    ),
    how: (
      <div className="terminal-text-container">
        <h3 className="text-matrix-green font-bold text-xl mb-4">How Does It Work?</h3>
        
        <h4 className="text-white font-bold mb-2">Real-Time Blockchain Monitoring:</h4>
        <p className="text-white leading-relaxed mb-4">
        ...
        <h4 className="text-white font-bold mb-2">Event Processing and Verification:</h4>
        <p className="text-white leading-relaxed mb-4">
        ...
        <h4 className="text-white font-bold mb-2">Data Integration & Calculation:</h4>
        <p className="text-white leading-relaxed mb-4">
    ...
    why: (
      <div className="terminal-text-container">
        <h3 className="text-matrix-green font-bold text-xl mb-4">Why Use the $MATRIX BuyBot?</h3>
        <p className="text-white leading-relaxed mb-4">
          The BuyBot is a cornerstone of $MATRIX&apos;s commitment to utility and community engagement. It provides:
        </p>
        <ul className="space-y-3 text-white mb-4">
          <li className="flex items-start">
            <span className="text-matrix-green mr-2">→</span> 
            <span><strong>Immediate Transparency:</strong> Community members receive instant updates on significant buy events, fostering a well-informed user base.</span>
          </li>
          <li className="flex items-start">
            <span className="text-matrix-green mr-2">→</span> 
            <span><strong>Enhanced Engagement:</strong> Visual and detailed alerts spark discussion and excitement, reinforcing $MATRIX as a dynamic project.</span>
          </li>
          <li className="flex items-start">
            <span className="text-matrix-green mr-2">→</span> 
            <span><strong>Reliability and Efficiency:</strong> Built with robust Go code and proven libraries, the BuyBot ensures consistent performance even during high-volume trading periods.</span>
          </li>
        </ul>
        <p className="text-white leading-relaxed">
    ...
    command: (
      <div className="terminal-text-container command-list">
        <h3 className="text-matrix-green font-bold text-xl mb-4">How to Use PepuBuyBot (The $MATRIX BuyBot)</h3>
        <p className="text-white leading-relaxed mb-4">
          PepuBuyBot is our custom Telegram bot that monitors $MATRIX buy events in real time on the Pepe Unchained network. It sends engaging, emoji-powered alerts to keep you instantly informed about every transaction.
        </p>
        
        <div className="command-terminal">
          <div className="command">
            <span className="command-text">/help</span>
            <p className="command-desc">Shows a list of all available commands and a brief description of each.</p>
          </div>
          
          <div className="command">
            <span className="command-text">/setup &lt;tokenEmoji&gt; &lt;contractAddr&gt; &lt;poolAddr&gt; [buyValueLimit=0] [emojiRatio=10000] [maxEmojiRows=12]</span>
            <p className="command-desc">Initializes the bot with your configuration settings.</p>
            <div className="command-example">
              <p><strong>Example:</strong> /setup 🐸 0x1234567890abcdef 0xabcdef1234567890 25 50000 12</p>
            </div>
          </div>
          
          <div className="command">
            <span className="command-text">/start</span>
            <p className="command-desc">Starts or resumes monitoring based on your current configuration.</p>
          </div>
          
          <div className="command">
            <span className="command-text">/stop</span>
            <p className="command-desc">Stops monitoring (your configuration is preserved so you can resume with /start later).</p>
          </div>
          
          <div className="command">
            <span className="command-text">/reset</span>
            <p className="command-desc">Deletes the current configuration and stops monitoring, allowing you to set up the bot afresh.</p>
          </div>
          
          <div className="command">
            <span className="command-text">/setemoji &lt;emoji&gt;</span>
            <p className="command-desc">Updates the token emoji used in alerts.</p>
            <div className="command-example">
              <p><strong>Example:</strong> /setemoji 🐸</p>
            </div>
          </div>
          
          <div className="command">
            <span className="command-text">/setlimit &lt;amount&gt;</span>
            <p className="command-desc">Sets or updates the minimum USD buy limit required to trigger an alert.</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <section id="buybot" className="w-full min-h-screen py-16 md:py-24 flex items-center justify-center relative overflow-hidden">
      {/* Hintergrund-Effekt */}
      ...
      <div className="max-w-6xl w-full mx-auto px-4 relative z-20">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold">
            <span className="typing-effect" ref={typingRef}>{typedText}</span>
        ...
        <div className="matrix-slider-container">
          <div className="matrix-slider-header">
            <h3 className="text-matrix-green font-bold text-xl">BuyBot Notifications</h3>
            <p className="text-white opacity-70">Real examples from other Telegram channels</p>
          </div>
      ...
      <style jsx>{`
        ...
        .terminal-frame {
          ...
          border-radius: 6px;
          overflow: hidden;
          box-shadow: 0 0 20px rgba(0, 0, 0, 0.7), 0 0 30px rgba(0, 255, 65, 0.2);
          display: flex;
