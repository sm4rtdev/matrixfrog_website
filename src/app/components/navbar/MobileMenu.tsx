    ...
    <div className="mobile-menu">
      <div className="mobile-menu-container">
        <Link href={getNavLink("about")} onClick={() => setMenuOpen(false)}>
          <span className="mobile-menu-link hover-white">
            About
          </span>
        </Link>
        ...
        <div className="mobile-social-container">
          ...
          <a href="https://t.me/MatrixFrogPepu" className="social-button hover-white" aria-label="Telegram">
            <div className="social-icon">
              <svg className="mobile-social-icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Mobile Wallet Connect Matrix Glitch */}
        <div style={{marginTop: '16px', display: 'flex', justifyContent: 'center'}}>
          <div className="matrix-glitch" style={{pointerEvents: 'none', display: 'flex', alignItems: 'center'}}>
            <svg style={{width: '1.25rem', height: '1.25rem', marginRight: '6px'}} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
