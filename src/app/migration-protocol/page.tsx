...
import MatrixInfoTabs from './components/MatrixInfoTabs';

import './components/styles.css'; // Importiere die ausgelagerten Styles

export default function MigrationProtocolPage() {
